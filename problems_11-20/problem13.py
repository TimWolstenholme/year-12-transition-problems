#Caesar cipher
apply_shift=lambda letter,shift: chr(ord(letter)+shift) if not  (ord(letter)+shift<91 and letter.upper()==letter) and (ord(letter)+shift<123 and letter.lower()==letter) else chr(ord(letter)+shift-26) if letter !=' ' else letter
